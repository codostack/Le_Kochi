...
const LeKochiDownloadBanner = () => {
  return (
    /* 
       The whole wrapper now utilizes your exact custom hex color #06120a.
       Removed the solid zinc card background so the color flows seamlessly throughout.
    */
    <div className="w-full h-auto bg-[#06120a] text-zinc-100 font-sans py-16 px-4 select-none flex items-center justify-center">
      
      {/* Semi-transparent inner card to let the deep green background breathe */}
      <div className="w-full max-w-md bg-[#06120a] p-6 text-center  relative overflow-hidden ">
        ...
        <div className="mt-6 flex flex-col gap-3.5 px-2">
          ...
          <button className="w-full h-12 bg-neutral-900/80 border border-zinc-800/50 rounded-full flex items-center justify-center gap-3 shadow-inner group active:bg-neutral-800/60 transition-colors cursor-pointer">
          ...
          <button className="w-full h-12 bg-zinc-900/80 border border-zinc-800/50 rounded-full flex items-center justify-center gap-3 shadow-inner group active:bg-zinc-800/60 transition-colors cursor-pointer">
